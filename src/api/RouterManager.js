...
// const FianancingApplyChange = '/financing/FianancingApplyChange';
// const FianancingApplyDetail = '/financing/FianancingApplyDetail';
...
export default {
  ...
  CalculateDetail,
  FianancingApply,
  // FianancingApplyChange,
  // FianancingApplyDetail,
  AddReceivables,
  LedgerDetail,
  LedgerPayment,
  LedgerRepayment,
